...
from evals.video_mme.dataset import DEFAULT_MANIFEST, DEFAULT_OUTPUT_ROOT, DEFAULT_VIDEO_ROOT, load_video_mme_examples


def main() -> None:
    parser = argparse.ArgumentParser(description="Run pure uniform-frame VLM baseline on VideoMME.")

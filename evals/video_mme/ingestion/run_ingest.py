...
from evals.video_mme.dataset import DEFAULT_FEATURE_ROOT, DEFAULT_MANIFEST, DEFAULT_VIDEO_ROOT, load_video_mme_examples


def main() -> None:
    parser = argparse.ArgumentParser(description="Build 1 FPS OpenCLIP caches for a Video-MME manifest.")
    ...
    examples = load_video_mme_examples(args.manifest, video_root=args.video_root)

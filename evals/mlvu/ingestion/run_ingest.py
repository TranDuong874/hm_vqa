...
from evals.mlvu.dataset import DEFAULT_FEATURE_ROOT, DEFAULT_MANIFEST, DEFAULT_VIDEO_ROOT, load_mlvu_examples


def main() -> None:
    parser = argparse.ArgumentParser(description="Build 1 FPS OpenCLIP caches for an MLVU MCQ manifest.")
